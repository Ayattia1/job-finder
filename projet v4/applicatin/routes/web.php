...
use App\Http\Controllers\Backend\CandidatsController;
use App\Http\Controllers\Backend\DashboardController;
use App\Http\Controllers\Backend\EmployeursController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('employeurs', EmployeursController::class);
    Route::post('/employeurs/{id}/status', [EmployeursController::class, 'updateStatus'])->name('employeurs.updateStatus');
