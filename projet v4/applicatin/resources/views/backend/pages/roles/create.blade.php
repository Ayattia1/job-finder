...
@section('title')
Création de Rôle - Panneau d'Administration
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Création de Rôle</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Tableau de Bord</a></li>
                    <li><a href="{{ route('admin.roles.index') }}">Tous les Rôles</a></li>
                    <li><span>Créer un Rôle</span></li>
                </ul>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.roles.store') }}" method="POST">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <h4 class="header-title">Créer un Nouveau Rôle</h4>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Entrez un nom de rôle" required autofocus value="{{ old('name') }}">
                        </div>
