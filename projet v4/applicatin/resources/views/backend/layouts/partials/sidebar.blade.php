        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    @if ( $usr->can('profile.view') ||  $usr->can('profile.edit') ||  $usr->can('profile.delete')  || $usr->can('candidat.view'))
                    <li>
                        <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-user"></i><span>
                            Profils
                        </span></a>
                        <ul class="collapse {{ Route::is('admin.profiles.index') || Route::is('admin.profiles.edit')  || Route::is('admin.bans.index') || Route::is('admin.bans.edit') || Route::is('admin.candidats.index') || Route::is('admin.profiles.show') ? 'in' : ''}}">
                            ...
                            <li class="{{ Route::is('admin.candidats.index') || Route::is('admin.candidats.edit') ? 'active' : '' }}"><a href="{{ route('admin.candidats.index') }}">Tous Les candidats </a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
                    ...
                    <li>
                        ...
                        <ul class="collapse {{ Route::is('admin.employeurs.index') || Route::is('admin.employeurs.edit')  || Route::is('admin.employeurs.status') || Route::is('admin.employeurs.show') ? 'in' : ''}}">
                            ...
                            @if ($usr->can('employeur.view'))
                                <li class="{{ Route::is('admin.employeurs.index')  || Route::is('admin.employeurs.edit') ? 'active' : '' }}"><a href="{{ route('admin.employeurs.index') }}">tous les employeurs </a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
